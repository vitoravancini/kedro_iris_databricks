...
# iris_kedro_databricks documentation build
...
from iris_kedro_databricks import __version__ as release

# -- Project information -----------------------------------------------------

project = "iris_kedro_databricks"
author = "Kedro"
...
htmlhelp_basename = "iris_kedro_databricksdoc"
...
latex_documents = [
    (
        master_doc,
        "iris_kedro_databricks.tex",
        "iris_kedro_databricks Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "iris_kedro_databricks",
        "Project iris_kedro_databricks codebase.",
        "Nearest-Neighbour",
    )
]
